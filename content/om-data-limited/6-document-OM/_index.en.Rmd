...
Each section has a series of second level headings (e.g., ## M) which correspond to the slots of that object. In this example, the text below these headings indicates that this parameter was borrowed from another object (e.g 'Borrowed from: Albacore'). 
...
You can view more completed operating models and OM documentation reports in the [Operating Model Library](/om-library).
