...
Finally, to remove parameters from estimation either because they're just placeholders (indices 1-3) or they should be fixed in the model (index 5), we provide the map argument for `ivul_par` with `map_ivul_par`:
