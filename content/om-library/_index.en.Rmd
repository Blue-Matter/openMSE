...
DF <- DF %>% 
  ...
  mutate('Data Report'=paste0("<a href='", DF$Data.Report,"'download> Link</a>")) 
...
ind <- !DF$hasDatarep
if (sum(ind)>0) DF['Data Report'][ind,1] <- ''

DFout <- DF %>% select(Name, Species, Region, Agency, 'OM Report', 'Data Report', 'OM Excel', 'OM R Data', Class, Family) 
