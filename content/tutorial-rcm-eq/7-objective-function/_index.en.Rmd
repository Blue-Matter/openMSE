...
\textrm{logit}^{-1}(x^{\textrm{L5}}_b) &\sim \textrm{Beta}(1.01, 1.01)\\
...
```{r beta-prior, echo = FALSE, fig.cap="Beta prior for aiding convergence with constants removed where x is the parameter and y is the prior density evaluated at x."}
x <- seq(0.01, 0.99, 0.01)
y <- x^0.01 * (1 - x)^0.01
plot(x, -log(y), typ = "l", ylim = c(0, 0.1))
```
